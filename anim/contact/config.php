...
define('CONTACTFORM_TO_NAME', 'Sender');
...
define('CONTACTFORM_RECAPTCHA_SITE_KEY', '6LehS_EZAAAAAOVEQIlhRapoMH0-CiJDhjF-aSAL');
define('CONTACTFORM_RECAPTCHA_SECRET_KEY', '6LehS_EZAAAAAFnokCWi1sMa8uLGvxfVE0z1bL_d');
